...
$(document).ready(function() {
  ...
  async function cargarusuarios() {
     //fetch sirve para llamar a bdd, en este caso la de tomcat que es en la que corre la app con spring, get es para sacar datos, pull es para actualizar/carga datos
      ...
      let usuariohtml='<tr ><td>'+usuario.id+ '</td><td>'+usuario.username+'</td><td>Edinburgh</td><td>61</td><td>2011/04/25</td><td> <a href="#" class="btn btn-danger btn-circle btn-sm"><i class="fas fa-trash"></i></a></td></tr>'
